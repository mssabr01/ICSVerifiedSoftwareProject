...
void post_init(void) WEAK;
    ...
    void signtx_iface__init(void) WEAK;

    void signtx_iface_timing_get_points(char ***points, size_t *size);
    uint64_t signtx_iface_timing_get_entry(unsigned iteration, char *point);
    void signtx_iface_timing_reset(void);
