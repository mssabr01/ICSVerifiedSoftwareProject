...
trustnet_in1:   while Len(incomingMessages) > 0 do
                    if Len(incomingMessages) > 1 then
                        uti1: msg := Head(incomingMessages);                \*pop off message from 
                        uti2: incomingMessages := Tail(incomingMessages);   \*list of test messages
                    else
...
\* Last modified Mon Jun 03 15:10:34 EDT 2019 by mssabr01
