...
\@x{ MessagesToSerialPort \.{\defeq}}%
 ...
 ,\,\@w{3} ,\,\@w{7} ,\,\@w{E} ,\,\@w{C} ,\,\@w{R} ,\,\@w{L} ,\,\@w{1}
 ,\,\@w{0} ,\,\@w{3} ,\,\@w{0} ,\,\@w{0} ,\,\@w{6} ,\,\@w{B} ,\,\@w{0}
 ,\,\@w{0} ,\,\@w{0} ,\,\@w{3} ,\,\@w{7} ,\,\@w{E} ,\,\@w{C} ,\,\@w{G}
 ,\,\@w{L} ,\,\@w{F} {\rangle} ,\,}%
 \@x{\@s{21.40} {\langle}\@w{:} ,\,\@w{1} ,\,\@w{1} ,\,\@w{0} ,\,\@w{3}
 ,\,\@w{0} ,\,\@w{0} ,\,\@w{6} ,\,\@w{B} ,\,\@w{0} ,\,\@w{0} ,\,\@w{0}
 ,\,\@w{:} ,\,\@w{1} ,\,\@w{1} ,\,\@w{0} ,\,\@w{3} ,\,\@w{0} ,\,\@w{0}
 ,\,\@w{6} ,\,\@w{B} ,\,\@w{0} ,\,\@w{0} ,\,\@w{0} ,\,\@w{3} ,\,\@w{7}
 ,\,\@w{E} ,\,\@w{C} ,\,\@w{R} ,\,\@w{L} ,\,\@w{F} {\rangle} ,\,}%
\@y{%
 this one starts a new modbus packet half way through the message
}%
\@xx{}%
\@x{\@s{21.40} {\langle} {\rangle} ,\,}%
\@x{\@s{21.40} {\langle}\@w{\ } {\rangle} ,\,}%
\@x{ {\langle}\@w{!} {\rangle} ,\,}%
\@x{ {\langle}\@w{\ensuremath{\backslash}"} {\rangle} ,\,}%
\@x{ {\langle}\@w{\#} {\rangle} ,\,}%
\@x{ {\langle}\@w{\$} {\rangle} ,\,}%
\@x{ {\langle}\@w{\%} {\rangle} ,\,}%
\@x{ {\langle}\@w{\&} {\rangle} ,\,}%
...
\@x{ {\langle}\@w{Z} {\rangle} ,\,}%
\@x{ {\langle}\@w{[} {\rangle} ,\,}%
 \@x{ {\langle}\@w{\ensuremath{\backslash}\ensuremath{\backslash}} {\rangle}
 ,\,}%
\@x{ {\langle}\@w{]} {\rangle} ,\,}%
\@x{ {\langle}\@w{\ensuremath{\ct}} {\rangle} ,\,}%
\@x{ {\langle}\@w{\_} {\rangle} ,\,}%
\@x{ {\langle}\@w{a} {\rangle} ,\,}%
\@x{ {\langle}\@w{b} {\rangle} ,\,}%
\@x{ {\langle}\@w{c} {\rangle} ,\,}%
...
\@x{ {\langle}\@w{\ensuremath{|}} {\rangle} ,\,}%
\@x{ {\langle}\@w{\}} {\rangle} ,\,}%
\@x{ {\langle}\@w{\ensuremath{\sim}} {\rangle}}%
\@pvspace{8.0pt}%
\@x{\@s{25.76} \}}%
\@pvspace{8.0pt}%
\@x{\@s{3.88}}%
...
\@xx{}%
 \@x{ {\VARIABLES} rx ,\, rxBuf ,\, rxReg ,\, incMessage ,\, applicationBuffer
 ,\, pc}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} rx ,\, rxBuf ,\, rxReg ,\, incMessage ,\,
 applicationBuffer ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{2.02} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{37.72} \.{\land} rx \.{=} {\FALSE}}%
\@x{\@s{37.72} \.{\land} rxBuf \.{=} {\langle} {\rangle}}%
\@x{\@s{37.72} \.{\land} rxReg\@s{1.23} \.{=} {\langle} {\rangle}}%
\@x{\@s{37.72} \.{\land} incMessage \.{\in} MessagesToSerialPort}%
\@x{\@s{37.72} \.{\land} applicationBuffer \.{=} {\langle} {\rangle}}%
\@x{\@s{37.72} \.{\land} pc \.{=}\@w{idle}}%
\@pvspace{8.0pt}%
\@x{ idle\@s{2.24} \.{\defeq} \.{\land} pc \.{=}\@w{idle}}%
\@x{\@s{37.72} \.{\land} {\IF} Len ( incMessage ) \.{=} 0}%
\@x{\@s{60.99} \.{\THEN} \.{\land} pc \.{'} \.{=}\@w{start}}%
\@x{\@s{92.30} \.{\land} rxReg \.{'} \.{=} {\langle} {\rangle}}%
\@x{\@s{92.30} \.{\land} {\UNCHANGED} {\langle} incMessage {\rangle}}%
 \@x{\@s{60.99} \.{\ELSE} \.{\land} rxReg \.{'} \.{=} {\langle} Head (
 incMessage ) {\rangle}}%
\@x{\@s{92.30} \.{\land} incMessage \.{'} \.{=} Tail ( incMessage )}%
\@x{\@s{92.30} \.{\land} pc \.{'} \.{=}\@w{start}}%
 \@x{\@s{37.72} \.{\land} {\UNCHANGED} {\langle} rx ,\, rxBuf ,\,
 applicationBuffer {\rangle}}%
\@pvspace{8.0pt}%
\@x{ start \.{\defeq} \.{\land} pc \.{=}\@w{start}}%
 \@x{\@s{39.89} \.{\land} {\IF} rxReg \.{\neq} {\langle} {\rangle} \.{\land}
 Len ( rxBuf ) \.{<} MAXMODBUSSIZE}%
\@x{\@s{63.16} \.{\THEN} \.{\land} pc \.{'} \.{=}\@w{receive}}%
\@x{\@s{63.16} \.{\ELSE} \.{\land} pc \.{'} \.{=}\@w{alldone}}%
 \@x{\@s{39.89} \.{\land} {\UNCHANGED} {\langle} rx ,\, rxBuf ,\, rxReg ,\,
 incMessage ,\, applicationBuffer {\rangle}}%
\@pvspace{8.0pt}%
\@x{ receive \.{\defeq} \.{\land} pc \.{=}\@w{receive}}%
\@x{\@s{48.38} \.{\land} {\IF} Head ( rxReg ) \.{=}\@w{:}}%
\@x{\@s{71.65} \.{\THEN} \.{\land} rxBuf \.{'} \.{=} {\langle} {\rangle}}%
\@x{\@s{71.65} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{102.96} \.{\land} rxBuf \.{'} \.{=} rxBuf}%
\@x{\@s{48.38} \.{\land} pc \.{'} \.{=}\@w{r1}}%
 \@x{\@s{48.38} \.{\land} {\UNCHANGED} {\langle} rx ,\, rxReg ,\, incMessage
 ,\, applicationBuffer {\rangle}}%
\@pvspace{8.0pt}%
\@x{ r1 \.{\defeq} \.{\land} pc \.{=}\@w{r1}}%
\@x{\@s{29.18} \.{\land} rxBuf \.{'} \.{=} rxBuf \.{\circ} rxReg}%
\@x{\@s{29.18} \.{\land} pc \.{'} \.{=}\@w{r2}}%
 \@x{\@s{29.18} \.{\land} {\UNCHANGED} {\langle} rx ,\, rxReg ,\, incMessage
 ,\, applicationBuffer {\rangle}}%
\@pvspace{8.0pt}%
\@x{ r2 \.{\defeq} \.{\land} pc \.{=}\@w{r2}}%
\@x{\@s{29.18} \.{\land} rxReg \.{'} \.{=} {\langle} {\rangle}}%
\@x{\@s{29.18} \.{\land} pc \.{'} \.{=}\@w{check}}%
 \@x{\@s{29.18} \.{\land} {\UNCHANGED} {\langle} rx ,\, rxBuf ,\, incMessage
 ,\, applicationBuffer {\rangle}}%
\@pvspace{8.0pt}%
\@x{ check \.{\defeq} \.{\land} pc \.{=}\@w{check}}%
\@x{\@s{42.96} \.{\land} {\IF} IsModbus ( rxBuf )}%
\@x{\@s{66.23} \.{\THEN} \.{\land} rx \.{'} \.{=} {\TRUE}}%
\@x{\@s{97.54} \.{\land} applicationBuffer \.{'} \.{=} rxBuf}%
\@x{\@s{97.54} \.{\land} pc \.{'} \.{=}\@w{alldone}}%
\@x{\@s{66.23} \.{\ELSE} \.{\land} pc \.{'} \.{=}\@w{idle}}%
 \@x{\@s{97.54} \.{\land} {\UNCHANGED} {\langle} rx ,\, applicationBuffer
 {\rangle}}%
 \@x{\@s{42.96} \.{\land} {\UNCHANGED} {\langle} rxBuf ,\, rxReg ,\,
 incMessage {\rangle}}%
\@pvspace{8.0pt}%
\@x{ alldone \.{\defeq} \.{\land} pc \.{=}\@w{alldone}}%
\@x{\@s{50.81} \.{\land} rxBuf \.{'} \.{=} {\langle} {\rangle}}%
\@x{\@s{50.81} \.{\land} rxReg \.{'}\@s{1.23} \.{=} {\langle} {\rangle}}%
\@x{\@s{50.81} \.{\land} pc \.{'} \.{=}\@w{Done}}%
 \@x{\@s{50.81} \.{\land} {\UNCHANGED} {\langle} rx ,\, incMessage ,\,
 applicationBuffer {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} idle \.{\lor} start \.{\lor} receive \.{\lor} r1
 \.{\lor} r2 \.{\lor} check \.{\lor} alldone}%
\@x{\@s{52.13} \.{\lor}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{16.4} \.{\land} Len ( rxBuf ) \.{\leq} MAXMODBUSSIZE}%
\@x{\@s{16.4}}%
\@y{%
 application buffer never overflows
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} Len ( applicationBuffer ) \.{\leq} MAXMODBUSSIZE}%
\@x{\@s{16.4}}%
\@y{%
 only valid modbus makes it to the app buffer
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} IsModbus ( applicationBuffer ) \.{\lor}
 applicationBuffer \.{=} {\langle} {\rangle}}%
\@x{\@s{16.4}}%
\@y{%
 flag is raised if and only if there is valid modbus in app buffer
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} rx \.{=} {\TRUE} \.{\equiv} IsModbus (
 applicationBuffer )}%
\@pvspace{8.0pt}%
\@x{ LIVELINESS \.{\defeq}}%
\@x{\@s{16.4}}%
...
\@xx{}%
 \@x{\@s{16.4} \.{\land} IsModbus ( incMessage ) \.{\leadsto} IsModbus (
 applicationBuffer )}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 if valid modbus comes through then it gets flagged for the application to
 consume
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} IsModbus ( incMessage ) \.{\leadsto} rx \.{=}
 {\TRUE}}%
\@pvspace{16.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Mon} May 07
 18:59:34 \ensuremath{EDT} 2018 by \ensuremath{SabraouM
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat May 05 11:36:54 \ensuremath{EDT}
