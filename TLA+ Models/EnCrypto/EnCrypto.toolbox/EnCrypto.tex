...
\@x{}\moduleLeftDash\@xx{ {\MODULE} EnCrypto}\moduleRightDash\@xx{}%
\@x{ {\LOCAL} {\INSTANCE} Sequences}%
\@x{ {\LOCAL} {\INSTANCE} Naturals}%
\@x{ {\LOCAL} {\INSTANCE} SSWPacket}%
\@x{ {\LOCAL} {\INSTANCE} Modbus}%
\@pvspace{8.0pt}%
\@x{ {\LOCAL} HMACSIZE \.{\defeq} 64}%
\@x{ {\LOCAL} MINMESSAGESIZE \.{\defeq} 1}%
\@x{ {\LOCAL} MINMACMESSAGESIZE \.{\defeq} 65}%
\@x{ {\LOCAL} PASSWORD \.{\defeq}\@w{lolpassword}}%
 \@x{ {\LOCAL} BareMessages \.{\defeq} \{ {\langle}\@w{:} ,\,\@w{1} ,\,\@w{1}
 ,\,\@w{0} ,\,\@w{3} ,\,\@w{0} ,\,\@w{0} ,\,\@w{6} ,\,\@w{B} ,\,\@w{0}
 ,\,\@w{0} ,\,\@w{0} ,\,\@w{3} ,\,\@w{7} ,\,\@w{E} ,\,\@w{C} ,\,\@w{R}
 ,\,\@w{L} ,\,\@w{F} {\rangle} ,\,}%
 \@x{\@s{121.85} {\langle}\@w{D} ,\,\@w{9} ,\,\@w{2} ,\,\@w{8} ,\,\@w{D}
 ,\,\@w{9} ,\,\@w{2} ,\,\@w{8} ,\,}%
 \@x{\@s{129.84}\@w{7} ,\,\@w{5} ,\,\@w{3} ,\,\@w{0} ,\,\@w{7} ,\,\@w{5}
 ,\,\@w{3} ,\,\@w{0} ,\,}%
 \@x{\@s{129.84}\@w{9} ,\,\@w{8} ,\,\@w{5} ,\,\@w{C} ,\,\@w{9} ,\,\@w{8}
 ,\,\@w{5} ,\,\@w{C} ,\,}%
 \@x{\@s{129.84}\@w{E} ,\,\@w{B} ,\,\@w{B} ,\,\@w{A} ,\,\@w{E} ,\,\@w{B}
 ,\,\@w{B} ,\,\@w{A} ,\,}%
 \@x{\@s{129.84}\@w{D} ,\,\@w{9} ,\,\@w{2} ,\,\@w{8} ,\,\@w{D} ,\,\@w{9}
 ,\,\@w{2} ,\,\@w{8} ,\,}%
 \@x{\@s{129.84}\@w{7} ,\,\@w{5} ,\,\@w{3} ,\,\@w{0} ,\,\@w{7} ,\,\@w{5}
 ,\,\@w{3} ,\,\@w{0} ,\,}%
 \@x{\@s{129.84}\@w{9} ,\,\@w{8} ,\,\@w{5} ,\,\@w{C} ,\,\@w{9} ,\,\@w{8}
...
\pcalshadingtrue
\csyntaxfalse
\@x{\@s{8.2} {\p@mmfair} {\p@algorithm} EnCrypto}%
\@pvspace{8.0pt}%
\@x{ {\p@variables}\@s{8.2} macMessage \.{=} {\langle} {\rangle} ,\,}%
\@x{\@s{55.96} hmac \.{=} {\langle} {\rangle} ,\,}%
\@x{\@s{55.96} bareMessage \.{\in} BareMessages ,\,}%
...
\@x{ {\p@begin}}%
\@pvspace{8.0pt}%
 \@x{ msgCheck\@s{.5}\textrm{:}\@s{3}\@s{8.2} {\p@if} Len ( bareMessage )
 \.{\geq} MINMESSAGESIZE}%
 \@x{\@s{72.61} {\p@then} hmac \.{:=} HMAC ( bareMessage ,\, PASSWORD )
 {\p@semicolon}}%
\@y{%
 hash it and the password
}%
\@xx{}%
 \@x{\@s{102.30} h1\@s{.5}\textrm{:}\@s{3} macMessage \.{:=} {\langle}\@w{!}
 {\rangle} \.{\circ} hmac \.{\circ} bareMessage {\p@semicolon}}%
\@x{\@s{102.30} result \.{:=} SendMessage ( macMessage ) {\p@semicolon}}%
...
\@xx{}%
 \@x{ {\VARIABLES} macMessage ,\, hmac ,\, bareMessage ,\, flag ,\,
 generatedHMAC ,\, result ,\, pc}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} macMessage ,\, hmac ,\, bareMessage ,\, flag
 ,\, generatedHMAC ,\, result ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{2.02} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{37.72} \.{\land} macMessage \.{=} {\langle} {\rangle}}%
\@x{\@s{37.72} \.{\land} hmac \.{=} {\langle} {\rangle}}%
\@x{\@s{37.72} \.{\land} bareMessage \.{\in} BareMessages}%
...
\@x{\@s{62.38} \.{\land} {\IF} Len ( bareMessage ) \.{\geq} MINMESSAGESIZE}%
 \@x{\@s{85.65} \.{\THEN} \.{\land} hmac \.{'} \.{=} HMAC ( bareMessage ,\,
 PASSWORD )}%
\@x{\@s{116.96} \.{\land} pc \.{'} \.{=}\@w{h1}}%
\@x{\@s{85.65} \.{\ELSE} \.{\land} pc \.{'} \.{=}\@w{Done}}%
\@x{\@s{116.96} \.{\land} hmac \.{'} \.{=} hmac}%
 \@x{\@s{62.38} \.{\land} {\UNCHANGED} {\langle} macMessage ,\, bareMessage
 ,\, flag ,\, generatedHMAC ,\,}%
\@x{\@s{135.97} result {\rangle}}%
\@pvspace{8.0pt}%
\@x{ h1 \.{\defeq} \.{\land} pc \.{=}\@w{h1}}%
 \@x{\@s{29.76} \.{\land} macMessage \.{'} \.{=} {\langle}\@w{!} {\rangle}
 \.{\circ} hmac \.{\circ} bareMessage}%
\@x{\@s{29.76} \.{\land} result \.{'} \.{=} SendMessage ( macMessage \.{'} )}%
\@x{\@s{29.76} \.{\land} pc \.{'} \.{=}\@w{Done}}%
 \@x{\@s{29.76} \.{\land} {\UNCHANGED} {\langle} hmac ,\, bareMessage ,\, flag
 ,\, generatedHMAC {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} msgCheck \.{\lor} h1}%
\@x{\@s{52.13} \.{\lor}}%
\@y{\@s{0}%
...
\@x{\@s{16.4}}%
\@y{%
 can only contain valid \ensuremath{SSW} or be empty
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} IsSSW ( macMessage ) \.{\lor} macMessage \.{=}
 {\langle} {\rangle}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 The message gets sent if and only if its valid \ensuremath{SSW
}}%
\@xx{}%
\@x{\@s{16.4} \.{\land} IsSSW ( macMessage ) \.{\equiv} result \.{=} {\TRUE}}%
\@x{\@s{16.4}}%
\@y{%
 the message in the buffer is at least the minimum \ensuremath{SSW} size
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} Len ( macMessage ) \.{\geq} MINMACMESSAGESIZE
 \.{\lor} Len ( macMessage ) \.{=} 0}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 the plaintext can never be sent without being processed
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} bareMessage \.{\neq} macMessage}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 the password is never changed
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} PASSWORD \.{=}\@w{lolpassword}}%
\@pvspace{8.0pt}%
\@x{ LIVELINESS \.{\defeq}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{16.4} \.{\land} Len ( bareMessage ) \.{\geq} MINMESSAGESIZE
 \.{\leadsto} result \.{=} {\TRUE}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 03:38:23 \ensuremath{EDT} 2018 by \ensuremath{SabraouM
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun May 06 15:34:11 \ensuremath{EDT}
