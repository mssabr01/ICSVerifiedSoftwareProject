...
\@x{}\moduleLeftDash\@xx{ {\MODULE} DeCrypto}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\LOCAL} {\INSTANCE} Sequences}%
\@x{ {\LOCAL} {\INSTANCE} Naturals}%
\@x{ {\LOCAL} {\INSTANCE} SSWPacket}%
\@pvspace{8.0pt}%
\@x{ {\LOCAL} HMACSIZE \.{\defeq} 64}%
\@x{ {\LOCAL} START \.{\defeq}\@w{!}}%
\@x{ {\LOCAL} MINMESSAGESIZE \.{\defeq} 65}%
\@x{ {\LOCAL} PASSWORD \.{\defeq}\@w{lolpassword}}%
\@x{ {\LOCAL} SignedMessages \.{\defeq} \{ isSSW ,\,}%
\@x{\@s{120.40} notSSW ,\,}%
 \@x{\@s{120.40} {\langle}\@w{D} ,\,\@w{9} ,\,\@w{2} ,\,\@w{8} ,\,\@w{D}
 ,\,\@w{9} ,\,\@w{2} ,\,\@w{8} ,\,}%
 \@x{\@s{128.39}\@w{7} ,\,\@w{5} ,\,\@w{3} ,\,\@w{0} ,\,\@w{7} ,\,\@w{5}
 ,\,\@w{3} ,\,\@w{0} ,\,}%
 \@x{\@s{128.39}\@w{9} ,\,\@w{8} ,\,\@w{5} ,\,\@w{C} ,\,\@w{9} ,\,\@w{8}
 ,\,\@w{5} ,\,\@w{C} ,\,}%
 \@x{\@s{128.39}\@w{E} ,\,\@w{B} ,\,\@w{B} ,\,\@w{A} ,\,\@w{E} ,\,\@w{B}
 ,\,\@w{B} ,\,\@w{A} ,\,}%
 \@x{\@s{128.39}\@w{D} ,\,\@w{9} ,\,\@w{2} ,\,\@w{8} ,\,\@w{D} ,\,\@w{9}
 ,\,\@w{2} ,\,\@w{8} ,\,}%
 \@x{\@s{128.39}\@w{7} ,\,\@w{5} ,\,\@w{3} ,\,\@w{0} ,\,\@w{7} ,\,\@w{5}
 ,\,\@w{3} ,\,\@w{0} ,\,}%
 \@x{\@s{128.39}\@w{9} ,\,\@w{8} ,\,\@w{5} ,\,\@w{C} ,\,\@w{9} ,\,\@w{8}
 ...
 ,\,\@w{5} ,\,\@w{C} {\rangle} \}}%
\@pvspace{8.0pt}%
 \@x{ HMAC ( str ,\, pass ) \.{\defeq} {\langle}\@w{l} ,\,\@w{o} ,\,\@w{l}
 ,\,\@w{h} ,\,\@w{m} ,\,\@w{a} ,\,\@w{c} {\rangle}}%
\@y{%
 not concerned with the inner workings of \ensuremath{SHA2
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ SendMessage ( str ) \.{\defeq} {\TRUE}}%
\@y{%
 sending message to another cell. Assuming this works
}%
\@xx{}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxfalse
\@x{\@s{8.2} {\p@mmfair} {\p@algorithm} DeCrypto}%
\@pvspace{8.0pt}%
\@x{ {\p@variables}\@s{8.2} signedMessage \.{\in} SignedMessages ,\,}%
\@x{\@s{55.96} bareMessage \.{=} {\langle} {\rangle} ,\,}%
\@x{\@s{55.96} flag \.{=} {\FALSE} ,\,}%
\@x{\@s{55.96} retreivedHMAC\@s{3.96} \.{=} {\langle} {\rangle} ,\,}%
\@x{\@s{55.96} generatedHMAC \.{=} {\langle} {\rangle} ,\,}%
\@x{\@s{55.96} result \.{=} {\FALSE} ,\,}%
\@x{\@s{55.96} CompareHMAC \.{\in} {\BOOLEAN} ,\,}%
\@y{%
 since we dont model \ensuremath{SHA2} this is random
}%
\@xx{}%
\@x{\@s{55.96} hmacsMatch \.{=} {\FALSE}}%
\@pvspace{8.0pt}%
\@x{ {\p@begin}}%
\@pvspace{8.0pt}%
 \@x{ msgCheck\@s{.5}\textrm{:}\@s{3}\@s{8.2} {\p@if} Len ( signedMessage )
 \.{\geq} MINMESSAGESIZE}%
 \@x{\@s{72.61} {\p@then} {\p@if} {\langle} Head ( signedMessage ) {\rangle}
 \.{=} {\langle}\@w{!} {\rangle}}%
 \@x{\@s{89.01} {\p@then} bareMessage \.{:=} GetMessage ( signedMessage )
 {\p@semicolon}}%
 \@x{\@s{118.70} retreivedHMAC \.{:=} GetHMAC ( signedMessage )
 {\p@semicolon}}%
 \@x{\@s{89.01} h1\@s{.5}\textrm{:}\@s{3} generatedHMAC \.{:=} HMAC (
 bareMessage ,\, PASSWORD ) {\p@semicolon}}%
 \@x{\@s{89.01} h2\@s{.5}\textrm{:}\@s{3} hmacsMatch \.{:=} CompareHMAC
 {\p@semicolon}}%
\@x{\@s{89.01} h3\@s{.5}\textrm{:}\@s{3} {\p@if} hmacsMatch}%
\@x{\@s{120.81} {\p@then} flag \.{:=} {\TRUE} {\p@semicolon}}%
\@x{\@s{150.50} result \.{:=} SendMessage ( bareMessage ) {\p@semicolon}}%
\@x{\@s{106.17} {\p@end} {\p@if} {\p@semicolon}}%
\@x{\@s{72.61} {\p@end} {\p@if} {\p@semicolon}}%
\@x{\@s{57.97} {\p@end} {\p@if} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@end} {\p@algorithm}}%
\@y{}%
\@xx{}%
...
\@xx{}%
 \@x{ {\VARIABLES} signedMessage ,\, bareMessage ,\, flag ,\, retreivedHMAC
 ,\, generatedHMAC ,\,}%
\@x{\@s{51.42} result ,\, CompareHMAC ,\, hmacsMatch ,\, pc}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} signedMessage ,\, bareMessage ,\, flag ,\,
 retreivedHMAC ,\, generatedHMAC ,\,}%
\@x{\@s{41.61} result ,\, CompareHMAC ,\, hmacsMatch ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{2.02} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{37.72} \.{\land} signedMessage \.{\in} SignedMessages}%
\@x{\@s{37.72} \.{\land} bareMessage \.{=} {\langle} {\rangle}}%
\@x{\@s{37.72} \.{\land} flag \.{=} {\FALSE}}%
\@x{\@s{37.72} \.{\land} retreivedHMAC\@s{3.96} \.{=} {\langle} {\rangle}}%
\@x{\@s{37.72} \.{\land} generatedHMAC \.{=} {\langle} {\rangle}}%
\@x{\@s{37.72} \.{\land} result \.{=} {\FALSE}}%
\@x{\@s{37.72} \.{\land} CompareHMAC \.{\in} {\BOOLEAN}}%
\@x{\@s{37.72} \.{\land} hmacsMatch \.{=} {\FALSE}}%
\@x{\@s{37.72} \.{\land} pc \.{=}\@w{msgCheck}}%
\@pvspace{8.0pt}%
\@x{ msgCheck \.{\defeq} \.{\land} pc \.{=}\@w{msgCheck}}%
\@x{\@s{62.38} \.{\land} {\IF} Len ( signedMessage ) \.{\geq} MINMESSAGESIZE}%
 \@x{\@s{85.65} \.{\THEN} \.{\land} {\IF} {\langle} Head ( signedMessage )
 {\rangle} \.{=} {\langle}\@w{!} {\rangle}}%
 \@x{\@s{140.23} \.{\THEN} \.{\land} bareMessage \.{'} \.{=} GetMessage (
 signedMessage )}%
 \@x{\@s{171.54} \.{\land} retreivedHMAC \.{'} \.{=} GetHMAC ( signedMessage
 )}%
\@x{\@s{171.54} \.{\land} pc \.{'} \.{=}\@w{h1}}%
\@x{\@s{140.23} \.{\ELSE} \.{\land} pc \.{'} \.{=}\@w{Done}}%
 \@x{\@s{171.54} \.{\land} {\UNCHANGED} {\langle} bareMessage ,\,
 retreivedHMAC {\rangle}}%
\@x{\@s{85.65} \.{\ELSE} \.{\land} pc \.{'} \.{=}\@w{Done}}%
 \@x{\@s{116.96} \.{\land} {\UNCHANGED} {\langle} bareMessage ,\,
 retreivedHMAC {\rangle}}%
 \@x{\@s{62.38} \.{\land} {\UNCHANGED} {\langle} signedMessage ,\, flag ,\,
 generatedHMAC ,\, result ,\,}%
\@x{\@s{135.97} CompareHMAC ,\, hmacsMatch {\rangle}}%
\@pvspace{8.0pt}%
\@x{ h1 \.{\defeq} \.{\land} pc \.{=}\@w{h1}}%
 \@x{\@s{29.76} \.{\land} generatedHMAC \.{'} \.{=} HMAC ( bareMessage ,\,
 PASSWORD )}%
\@x{\@s{29.76} \.{\land} pc \.{'} \.{=}\@w{h2}}%
 \@x{\@s{29.76} \.{\land} {\UNCHANGED} {\langle} signedMessage ,\, bareMessage
 ,\, flag ,\, retreivedHMAC ,\, result ,\,}%
\@x{\@s{103.35} CompareHMAC ,\, hmacsMatch {\rangle}}%
\@pvspace{8.0pt}%
\@x{ h2 \.{\defeq} \.{\land} pc \.{=}\@w{h2}}%
\@x{\@s{29.76} \.{\land} hmacsMatch \.{'} \.{=} CompareHMAC}%
\@x{\@s{29.76} \.{\land} pc \.{'} \.{=}\@w{h3}}%
 \@x{\@s{29.76} \.{\land} {\UNCHANGED} {\langle} signedMessage ,\, bareMessage
 ,\, flag ,\, retreivedHMAC ,\,}%
\@x{\@s{103.35} generatedHMAC ,\, result ,\, CompareHMAC {\rangle}}%
\@pvspace{8.0pt}%
\@x{ h3 \.{\defeq} \.{\land} pc \.{=}\@w{h3}}%
\@x{\@s{29.76} \.{\land} {\IF} hmacsMatch}%
\@x{\@s{53.03} \.{\THEN} \.{\land} flag \.{'} \.{=} {\TRUE}}%
\@x{\@s{84.34} \.{\land} result \.{'} \.{=} SendMessage ( bareMessage )}%
\@x{\@s{53.03} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{84.34} \.{\land} {\UNCHANGED} {\langle} flag ,\, result {\rangle}}%
\@x{\@s{29.76} \.{\land} pc \.{'} \.{=}\@w{Done}}%
 \@x{\@s{29.76} \.{\land} {\UNCHANGED} {\langle} signedMessage ,\, bareMessage
 ,\, retreivedHMAC ,\, generatedHMAC ,\,}%
\@x{\@s{103.35} CompareHMAC ,\, hmacsMatch {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} msgCheck \.{\lor} h1 \.{\lor} h2 \.{\lor} h3}%
\@x{\@s{52.13} \.{\lor}}%
\@y{\@s{0}%
 Disjunct to prevent deadlock on termination
}%
\@xx{}%
\@x{\@s{63.24} ( pc \.{=}\@w{Done} \.{\land} {\UNCHANGED} vars )}%
\@pvspace{8.0pt}%
 \@x{ Spec\@s{1.46} \.{\defeq} \.{\land} Init \.{\land} {\Box} [ Next ]_{
 vars}}%
\@x{\@s{39.83} \.{\land} {\WF}_{ vars} ( Next )}%
\@pvspace{8.0pt}%
\@x{ Termination \.{\defeq} {\Diamond} ( pc \.{=}\@w{Done} )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 END TRANSLATION
...
\@xx{}%
\@x{\@s{32.8} \.{\land} PASSWORD \.{=}\@w{lolpassword}}%
\@x{\@s{32.8}}%
\@y{\@s{0}%
 if we send something then it was valid \ensuremath{SSW
}}%
\@xx{}%
 \@x{\@s{32.8} \.{\land} flag \.{=} {\TRUE} \.{\implies} IsSSW ( signedMessage
 )}%
\@x{\@s{32.8}}%
\@y{\@s{0}%
 we forward a packet if and only if the \ensuremath{HMACs} match
}%
\@xx{}%
 \@x{\@s{32.8} \.{\land} result \.{=} {\TRUE} \.{\implies} hmacsMatch \.{=}
 {\TRUE}}%
\@pvspace{8.0pt}%
\@x{ LIVELINESS \.{\defeq}}%
\@x{\@s{32.8}}%
\@y{\@s{0}%
 if the \ensuremath{HMACs} match then we eventually send something
}%
\@xx{}%
 \@x{\@s{32.8} \.{\land} hmacsMatch \.{=} {\TRUE} \.{\leadsto} result \.{=}
 {\TRUE}}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Tue} May 08
 03:43:33 \ensuremath{EDT} 2018 by \ensuremath{SabraouM
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun May 06 09:03:31 \ensuremath{EDT}
 2018 by \ensuremath{SabraouM
}%
\end{cpar}%
\end{lcom}%
\end{document}
