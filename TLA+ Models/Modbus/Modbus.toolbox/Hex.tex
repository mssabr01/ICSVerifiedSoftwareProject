...
\@x{}\moduleLeftDash\@xx{ {\MODULE} Hex}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS}}%
\@x{\@s{16.4} Naturals ,\,}%
\@x{\@s{16.4} Sequences ,\,}%
...
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\RECURSIVE} HighestMultipleLEQ ( \_ ,\, \_ ,\, \_ )}%
\@x{ HighestMultipleLEQ ( a ,\, b ,\, current ) \.{\defeq}}%
\@x{\@s{16.4} \.{\LET} next \.{\defeq} current \.{+} 1 \.{\IN}}%
\@x{\@s{16.4} {\IF} next \.{*} b \.{>} a}%
\@x{\@s{16.4} \.{\THEN} current}%
\@x{\@s{16.4} \.{\ELSE} HighestMultipleLEQ ( a ,\, b ,\, next )}%
\@pvspace{8.0pt}%
\@x{ a \.{/} b \.{\defeq} HighestMultipleLEQ ( a ,\, b ,\, 0 )}%
\@pvspace{8.0pt}%
\@x{ HexDigit \.{\defeq} 0 \.{\dotdot} 15}%
\@pvspace{8.0pt}%
\@x{ Hex \.{\defeq} Seq ( HexDigit )}%
\@pvspace{8.0pt}%
\@x{ HexChar \.{\defeq}}%
 \@x{\@s{16.4} {\langle}\@w{0} ,\,\@w{1} ,\,\@w{2} ,\,\@w{3} ,\,\@w{4}
 ,\,\@w{5} ,\,\@w{6} ,\,\@w{7} ,\,\@w{8} ,\,\@w{9} ,\,\@w{A} ,\,\@w{B}
 ,\,\@w{C} ,\,\@w{D} ,\,\@w{E} ,\,\@w{F} {\rangle}}%
\@pvspace{8.0pt}%
\@x{ {\RECURSIVE} HexToString ( \_ )}%
\@x{ HexToString ( hex ) \.{\defeq}}%
\@x{\@s{16.4} {\IF} hex \.{=} {\langle} {\rangle}}%
\@x{\@s{16.4} \.{\THEN}\@w{}}%
 \@x{\@s{16.4} \.{\ELSE} HexChar [ Head ( hex ) \.{+} 1 ] \.{\circ}
 HexToString ( Tail ( hex ) )}%
\@pvspace{8.0pt}%
\@x{ {\RECURSIVE} NatToHex ( \_ )}%
\@x{ NatToHex ( val ) \.{\defeq}}%
\@x{\@s{16.4} \.{\LET}}%
\@x{\@s{32.8} prefix \.{\defeq} val \.{/} 16}%
\@x{\@s{32.8} remainder \.{\defeq} val \.{\%} 16}%
\@x{\@s{16.4} \.{\IN}}%
\@x{\@s{16.4} {\IF} prefix \.{=} 0}%
\@x{\@s{16.4} \.{\THEN} {\langle} remainder {\rangle}}%
\@x{\@s{16.4} \.{\ELSE} Append ( NatToHex ( prefix ) ,\, remainder )}%
\@pvspace{8.0pt}%
\@x{ TypeInvariant \.{\defeq}}%
\@x{\@s{16.4} \.{\land} hexValue \.{\in} Hex}%
\@x{\@s{16.4} \.{\land} natValue\@s{0.29} \.{\in} Nat}%
\@pvspace{8.0pt}%
\@x{ SafetyInvariant \.{\defeq}}%
\@x{\@s{16.4} \.{\land} hexValue \.{=} NatToHex ( natValue )}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} hexValue \.{=} {\langle} 0 {\rangle}}%
\@x{\@s{16.4} \.{\land} natValue\@s{0.29} \.{=} 0}%
\@pvspace{8.0pt}%
\@x{ {\RECURSIVE} IncrementedHexValue ( \_ )}%
\@x{ IncrementedHexValue ( hex ) \.{\defeq}}%
\@x{\@s{16.4} \.{\LET}}%
\@x{\@s{32.8} prefix \.{\defeq} SubSeq ( hex ,\, 1 ,\, Len ( hex ) \.{-} 1 )}%
\@x{\@s{32.8} last \.{\defeq} hex [ Len ( hex ) ]}%
\@x{\@s{16.4} \.{\IN}}%
\@x{\@s{16.4} {\IF} hex \.{=} {\langle} {\rangle}}%
\@x{\@s{16.4} \.{\THEN} {\langle} 1 {\rangle}}%
\@x{\@s{16.4} \.{\ELSE}}%
\@x{\@s{32.8} {\IF} last \.{<} 15}%
\@x{\@s{32.8} \.{\THEN} Append ( prefix ,\, last \.{+} 1 )}%
\@x{\@s{32.8} \.{\ELSE} Append ( IncrementedHexValue ( prefix ) ,\, 0 )}%
\@pvspace{8.0pt}%
\@x{ Increment \.{\defeq}}%
\@x{\@s{16.4} \.{\land} Print ( HexToString ( hexValue ) ,\, {\TRUE} )}%
 \@x{\@s{16.4} \.{\land} Print ( HexToString ( NatToHex ( natValue ) ) ,\,
 {\TRUE} )}%
 \@x{\@s{16.4} \.{\land} hexValue \.{'} \.{=} IncrementedHexValue ( hexValue
 )}%
\@x{\@s{16.4} \.{\land} natValue \.{'}\@s{0.29} \.{=} natValue \.{+} 1}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} Increment}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Last modified \ensuremath{Wed} May 02
 15:29:46 \ensuremath{EDT} 2018 by \ensuremath{SabraouM
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Wed} May 02 15:28:50
