...
\@x{}\moduleLeftDash\@xx{ {\MODULE} Modbus}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{%
 The set of all \ensuremath{Modbus} messages for a given network
}%
\@xx{}%
\@x{ {\EXTENDS}}%
\@x{\@s{16.4} Integers ,\,}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Data:\@s{17.5}0 up to 504 hex chars
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{LRC}:\@s{20.0}two hex char \ensuremath{Longitudinal} Redundancy
 Check (\ensuremath{LRC})
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
End:\@s{20.0}\ensuremath{\@w{CRLF}
}%
\end{cpar}%
\end{lcom}%
\@x{}%
...
\@xx{}%
\@x{ IsStart ( str ) \.{\defeq} str \.{=}\@w{:}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{%
 Address fields \ceqdash{57}
}%
\@xx{}%
\@x{ GetAddr ( str ) \.{\defeq} SubSeq ( str ,\, 2 ,\, 3 )}%
\@pvspace{8.0pt}%
\@x{ IsAddr ( str ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} Len ( str ) \.{=} 2}%
\@x{\@s{16.4} \.{\land} Head ( str ) \.{\in} HexChar}%
\@x{\@s{16.4} \.{\land} Head ( Tail ( str ) ) \.{\in} HexChar}%
\@pvspace{8.0pt}%
\@x{}%
\@y{%
 Function fields \ceqdash{56}
}%
\@xx{}%
\@x{ GetFunct ( str ) \.{\defeq} SubSeq ( str ,\, 4 ,\, 5 )}%
\@pvspace{8.0pt}%
\@x{ IsFunctionCode ( str ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} Len ( str ) \.{=} 2}%
\@x{\@s{16.4} \.{\land} Head ( str ) \.{\in} HexChar}%
\@x{\@s{16.4} \.{\land} Head ( Tail ( str ) ) \.{\in} HexChar}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{ GetData ( str ) \.{\defeq} SubSeq ( str ,\, 6 ,\, Len ( str ) \.{-} 3 )}%
\@pvspace{8.0pt}%
\@x{ IsData ( str ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} Len ( str ) \.{\in} 0 \.{\dotdot} 504}%
 \@x{\@s{16.4} \.{\land} str \.{=} [ x\@s{2.57} \.{\in} {\DOMAIN} str
 \.{\mapsto} x \.{\in} HexChar ]}%
\@pvspace{8.0pt}%
\@x{}%
\@y{%
...
\@xx{}%
 \@x{ GetEnd ( str ) \.{\defeq} SubSeq ( str ,\, Len ( str ) ,\, Len ( str )
 )}%
\@pvspace{8.0pt}%
\@x{ IsEnd ( str ) \.{\defeq} str \.{=}\@w{CRLF}}%
\@pvspace{16.0pt}%
\@x{}%
\@y{%
 \ensuremath{LRC} \ceqdash{68}
}%
\@xx{}%
 \@x{ GetLRC ( str ) \.{\defeq} SubSeq ( str ,\, Len ( str ) \.{-} 2 ,\, Len (
 str ) \.{-} 1 )}%
\@pvspace{8.0pt}%
\@x{ IsLRC ( str ) \.{\defeq} CheckLRC ( str )}%
\@x{}%
\@y{%
 \ensuremath{LRCInvariant \.{\defeq} CheckLRC(start \.{\circ} addr1 \.{\circ}
 addr2 \.{\circ} fc1 \.{\circ} fc2 \.{\circ} data \.{\circ} end)
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{%
 Helper Functions \ceqdash{55}
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ IsModbus ( message ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} Len ( message ) \.{\in} 9 \.{\dotdot} 513}%
\@x{\@s{16.4} \.{\land} IsStart ( Head ( message ) )}%
\@x{\@s{16.4} \.{\land} IsAddr ( GetAddr ( message ) )}%
\@x{\@s{16.4} \.{\land} IsFunctionCode ( GetFunct ( message ) )}%
\@x{\@s{16.4} \.{\land} IsData ( GetData ( message ) )}%
\@x{\@s{16.4} \.{\land} IsLRC ( GetLRC ( message ) )}%
\@x{\@s{16.4} \.{\land} IsEnd ( GetEnd ( message ) )}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 20:50:20 \ensuremath{EDT} 2018 by \ensuremath{SabraouM
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Thu}
 \ensuremath{Jan} 18 14:33:25 \ensuremath{EST} 2018 by \ensuremath{SabraouM
}%
\end{cpar}%
\end{lcom}%
\end{document}
