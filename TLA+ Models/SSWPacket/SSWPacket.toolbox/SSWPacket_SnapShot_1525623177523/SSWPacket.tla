...
TYPEOK ==
  \*
  /\ GetHMAC(isSSW) = <<"0","A","0","B","0","D","0","9","0","2","0","8","0","7","0","5","0","3","0","0","0","9","0","8","0",
                 "5","0","C","0","E","0","B","0","B","0","A","0","F","0","C","0","0","0","B","0","C","0","B","0","0","0",
                 "B","0","D","0","B","0","E","0","7","0","6","0","A">>
  /\ GetModbus(isSSW) = <<":","1","1","0","3","0","0","6","B","0","0","0","3","7","E","C","R","L","F">>
  /\ IsSSW(notSSW) = FALSE
  /\ IsSSW(notSSW2) = FALSE
  /\ IsSSW(isSSW) = TRUE
...
\* Last modified Sun May 06 12:12:26 EDT 2018 by SabraouM
