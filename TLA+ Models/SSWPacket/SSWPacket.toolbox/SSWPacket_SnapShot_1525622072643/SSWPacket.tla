...
ASSUME
  \*
  /\ Print(GetHMAC(isSSW),TRUE)
  /\ Print(GetModbus(isSSW),TRUE)
  /\ Print(IsSSW(notSSW), TRUE)
  /\ Print(IsSSW(isSSW), TRUE)
  \*/\ Print(IsModbus(<<"e","j","g","p","9","4","3","2","j","3","9","j","g","w","i","r","w">>), TRUE)


=============================================================================
\* Modification History
\* Last modified Sun May 06 11:53:15 EDT 2018 by SabraouM
