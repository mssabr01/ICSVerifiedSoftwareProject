...
\@x{}\moduleLeftDash\@xx{ {\MODULE} diehard}\moduleRightDash\@xx{}%
\@x{}%
\@y{\@s{0}%
 from the 1995 movie Die Hard 3. Bruce \ensuremath{Willis
}}%
\@xx{}%
\@x{ {\EXTENDS} Integers}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} smol ,\, big}%
\@pvspace{8.0pt}%
\@x{ TypeOK \.{\defeq} \.{\land} smol \.{\in} 0 \.{\dotdot} 3}%
\@x{\@s{56.14} \.{\land} big\@s{7.81} \.{\in} 0 \.{\dotdot} 5}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq} \.{\land} big\@s{7.81} \.{=} 0}%
\@x{\@s{35.70} \.{\land} smol \.{=} 0}%
\@pvspace{8.0pt}%
\@x{ FillSmol \.{\defeq} \.{\land} smol \.{'} \.{=} 3}%
\@x{\@s{56.60} \.{\land} big \.{'}\@s{7.81} \.{=} big}%
\@pvspace{8.0pt}%
\@x{ FillBig\@s{6.90} \.{\defeq} \.{\land} smol \.{'} \.{=} smol}%
\@x{\@s{56.60} \.{\land} big \.{'}\@s{7.81} \.{=} 5}%
\@pvspace{8.0pt}%
\@x{ EmptySmol \.{\defeq} \.{\land} smol \.{'} \.{=} 0}%
\@x{\@s{69.63} \.{\land} big \.{'}\@s{7.81} \.{=} big}%
\@pvspace{8.0pt}%
\@x{ EmptyBig\@s{6.90} \.{\defeq} \.{\land} big \.{'}\@s{7.81} \.{=} 0}%
\@x{\@s{69.63} \.{\land} smol \.{'} \.{=} smol}%
\@pvspace{8.0pt}%
\@x{ SmolToBig\@s{2.19} \.{\defeq} {\IF} big \.{+} smol \.{\leq} 5}%
\@x{\@s{81.79} \.{\THEN} \.{\land} smol \.{'} \.{=} 0}%
\@x{\@s{113.10} \.{\land} big \.{'}\@s{7.81} \.{=} big \.{+} smol}%
\@x{\@s{81.79} \.{\ELSE}}%
\@x{\@s{102.29} \.{\land} big \.{'} \.{=} 5}%
\@x{\@s{102.29} \.{\land} smol \.{'} \.{=} smol \.{-} ( 5 \.{-} big )}%
\@pvspace{8.0pt}%
\@x{ BigToSmol\@s{2.04} \.{\defeq} {\IF} big \.{+} smol \.{\leq} 3}%
\@x{\@s{81.79} \.{\THEN}}%
\@x{\@s{102.29} \.{\land} smol \.{'} \.{=} big \.{+} smol}%
\@x{\@s{102.29} \.{\land} big \.{'}\@s{7.81} \.{=} 0}%
\@x{\@s{81.79} \.{\ELSE}}%
\@x{\@s{102.29} \.{\land} smol \.{'} \.{=} 3}%
 \@x{\@s{102.29} \.{\land} big \.{'}\@s{7.81} \.{=} big \.{-} ( 3 \.{-} smol
 )}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \.{\lor} FillSmol\@s{20.5}}%
\@y{%
 fill a jug
}%
\@xx{}%
\@x{\@s{39.83} \.{\lor} FillBig}%
\@x{\@s{39.83} \.{\lor} EmptySmol}%
\@x{\@s{39.83} \.{\lor} EmptyBig}%
\@x{\@s{39.83} \.{\lor} SmolToBig}%
\@x{\@s{39.83} \.{\lor} BigToSmol}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 26 22:24:26 \ensuremath{EST} 2018 by \ensuremath{SabraouM
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Jan} 26
 21:25:13 \ensuremath{EST} 2018 by \ensuremath{SabraouM
}%
\end{cpar}%
\end{lcom}%
\end{document}
