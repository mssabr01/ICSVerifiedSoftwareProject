...
\@x{}\moduleLeftDash\@xx{ {\MODULE} pluscaltest}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
...
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmalgorithm} FastMutex}%
 \@x{ {\p@lbrace} {\p@variables} x\@s{5.84} \.{=} 0 ,\, y \.{=} 0 ,\, b \.{=}
 [ i \.{\in} 1 \.{\dotdot} N \.{\mapsto} false ] {\p@semicolon}}%
 \@x{ {\p@process} {\p@lparen} Proc \.{\in}\@s{4.1} 1 \.{\dotdot} N
 {\p@rparen}}%
\@x{ {\p@variable} j {\p@semicolon}}%
\@x{ {\p@lbrace} ncs\@s{.5}\textrm{:}\@s{3} {\p@skip} {\p@semicolon}}%
\@y{\@s{0}%
 The Noncritical Section
}%
\@xx{}%
 \@x{ start\@s{.5}\textrm{:}\@s{3}\@s{3.70} b [ self ] \.{:=} true
 {\p@semicolon}}%
\@x{ lab1\@s{.5}\textrm{:}\@s{3}\@s{1.80} x \.{:=} self {\p@semicolon}}%
 \@x{ lab2\@s{.5}\textrm{:}\@s{3}\@s{1.80} {\p@if} {\p@lparen} y \.{\neq} 0
 {\p@rparen} {\p@lbrace} lab3\@s{.5}\textrm{:}\@s{3} b [ self ] \.{:=} false
 {\p@semicolon}}%
 \@x{ lab4\@s{.5}\textrm{:}\@s{3}\@s{1.80} {\p@await} y \.{=} 0
 {\p@semicolon}}%
\@x{ {\p@goto} start {\p@rbrace} {\p@semicolon}}%
\@x{ lab5\@s{.5}\textrm{:}\@s{3}\@s{5.47} y \.{:=} self {\p@semicolon}}%
 \@x{ lab6\@s{.5}\textrm{:}\@s{3}\@s{5.47} {\p@if} {\p@lparen} x \.{\neq} self
 {\p@rparen} {\p@lbrace} lab7\@s{.5}\textrm{:}\@s{3} b [ self ] \.{:=} false
 {\p@semicolon}}%
\@x{ j \.{:=} 1 {\p@semicolon}}%
 \@x{ lab8\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen} j \.{\leq} N
 {\p@rparen} {\p@lbrace} {\p@await} {\lnot} b [ j ] {\p@semicolon}}%
\@x{ j \.{:=} j \.{+} 1 {\p@rbrace} {\p@semicolon}}%
 \@x{ lab9\@s{.5}\textrm{:}\@s{3} {\p@if} {\p@lparen} y \.{\neq} self
 {\p@rparen} {\p@lbrace} lab10\@s{.5}\textrm{:}\@s{3} {\p@await} y \.{=} 0
 {\p@semicolon}}%
\@x{ {\p@goto} start {\p@rbrace} {\p@rbrace} {\p@semicolon}}%
\@x{ cs\@s{.5}\textrm{:}\@s{3} {\p@skip} {\p@semicolon}}%
\@y{\@s{0}%
 The Critical Section
}%
\@xx{}%
\@x{ lab11\@s{.5}\textrm{:}\@s{3} y \.{:=} 0 {\p@semicolon}}%
\@x{ lab12\@s{.5}\textrm{:}\@s{3} b [ self ] \.{:=} false {\p@semicolon}}%
\@x{ {\p@goto} ncs {\p@rbrace} {\p@rbrace}}%
\@y{}%
\@xx{}%
...
\@x{ {\VARIABLES} x ,\, y ,\, b ,\, pc ,\, j}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} x ,\, y ,\, b ,\, pc ,\, j {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ProcSet \.{\defeq} ( 1 \.{\dotdot} N )}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{35.70} \.{\land} x \.{=} 0}%
\@x{\@s{35.70} \.{\land} y\@s{0.10} \.{=} 0}%
 \@x{\@s{35.70} \.{\land} b\@s{0.61} \.{=} [ i \.{\in} 1 \.{\dotdot} N
 \.{\,|\,} \.{>} false ]}%
\@x{\@s{35.70}}%
\@y{\@s{0}%
 Process \ensuremath{Proc
}}%
\@xx{}%
 \@x{\@s{35.70} \.{\land} j \.{=} [ self \.{\in} 1 \.{\dotdot} N \.{\mapsto}
 defaultInitValue ]}%
...
\@x{\@s{58.22} \.{\land} {\TRUE}}%
 ...
 \.{=}\@w{start} ]}%
 \@x{\@s{58.22} \.{\land} {\UNCHANGED} {\langle} x ,\, y ,\, b ,\, j
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ start ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{start}}%
 \@x{\@s{64.10} \.{\land} b \.{'} \.{=} [ b {\EXCEPT} {\bang} [ self ] \.{=}
 true ]}%
 \@x{\@s{64.10} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{lab1} ]}%
\@x{\@s{64.10} \.{\land} {\UNCHANGED} {\langle} x ,\, y ,\, j {\rangle}}%
\@pvspace{8.0pt}%
\@x{ lab1 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{lab1}}%
\@x{\@s{60.99} \.{\land} x \.{'} \.{=} self}%
 \@x{\@s{60.99} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{lab2} ]}%
\@x{\@s{60.99} \.{\land} {\UNCHANGED} {\langle} y ,\, b ,\, j {\rangle}}%
\@pvspace{8.0pt}%
\@x{ lab2 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{lab2}}%
\@x{\@s{60.99} \.{\land} {\IF} y \.{\neq} 0}%
 \@x{\@s{84.26} \.{\THEN} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{lab3} ]}%
 \@x{\@s{84.26} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{lab5} ]}%
 \@x{\@s{60.99} \.{\land} {\UNCHANGED} {\langle} x ,\, y ,\, b ,\, j
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ lab3 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{lab3}}%
 \@x{\@s{60.99} \.{\land} b \.{'} \.{=} [ b {\EXCEPT} {\bang} [ self ] \.{=}
 false ]}%
 \@x{\@s{60.99} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{lab4} ]}%
\@x{\@s{60.99} \.{\land} {\UNCHANGED} {\langle} x ,\, y ,\, j {\rangle}}%
\@pvspace{8.0pt}%
\@x{ lab4 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{lab4}}%
\@x{\@s{60.99} \.{\land} y \.{=} 0}%
 \@x{\@s{60.99} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{start} ]}%
 \@x{\@s{60.99} \.{\land} {\UNCHANGED} {\langle} x ,\, y ,\, b ,\, j
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ lab5 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{lab5}}%
\@x{\@s{60.99} \.{\land} y \.{'} \.{=} self}%
 \@x{\@s{60.99} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{lab6} ]}%
\@x{\@s{60.99} \.{\land} {\UNCHANGED} {\langle} x ,\, b ,\, j {\rangle}}%
\@pvspace{8.0pt}%
\@x{ lab6 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{lab6}}%
\@x{\@s{60.99} \.{\land} {\IF} x \.{\neq} self}%
 \@x{\@s{84.26} \.{\THEN} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{lab7} ]}%
 \@x{\@s{84.26} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 ...
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ lab7 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{lab7}}%
 \@x{\@s{60.99} \.{\land} b \.{'} \.{=} [ b {\EXCEPT} {\bang} [ self ] \.{=}
 false ]}%
 \@x{\@s{60.99} \.{\land} j \.{'}\@s{0.71} \.{=} [ j {\EXCEPT} {\bang} [ self
 ] \.{=} 1 ]}%
 \@x{\@s{60.99} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{lab8} ]}%
\@x{\@s{60.99} \.{\land} {\UNCHANGED} {\langle} x ,\, y {\rangle}}%
\@pvspace{8.0pt}%
\@x{ lab8 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{lab8}}%
\@x{\@s{60.99} \.{\land} {\IF} j [ self ] \.{\leq} N}%
\@x{\@s{84.26} \.{\THEN} \.{\land} {\lnot} b [ j [ self ] ]}%
 \@x{\@s{115.57} \.{\land} j \.{'} \.{=} [ j {\EXCEPT} {\bang} [ self ] \.{=}
 j [ self ] \.{+} 1 ]}%
 \@x{\@s{115.57} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{lab8} ]}%
 \@x{\@s{84.26} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{lab9} ]}%
\@x{\@s{115.57} \.{\land} j \.{'} \.{=} j}%
\@x{\@s{60.99} \.{\land} {\UNCHANGED} {\langle} x ,\, y ,\, b {\rangle}}%
\@pvspace{8.0pt}%
\@x{ lab9 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{lab9}}%
\@x{\@s{60.99} \.{\land} {\IF} y \.{\neq} self}%
 \@x{\@s{84.26} \.{\THEN} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{lab10} ]}%
 \@x{\@s{84.26} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 ...
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ lab10 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{lab10}}%
\@x{\@s{65.99} \.{\land} y \.{=} 0}%
 \@x{\@s{65.99} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{start} ]}%
 \@x{\@s{65.99} \.{\land} {\UNCHANGED} {\langle} x ,\, y ,\, b ,\, j
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ cs ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{cs}}%
\@x{\@s{52.60} \.{\land} {\TRUE}}%
 \@x{\@s{52.60} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{lab11} ]}%
 \@x{\@s{52.60} \.{\land} {\UNCHANGED} {\langle} x ,\, y ,\, b ,\, j
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ lab11 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{lab11}}%
\@x{\@s{65.99} \.{\land} y \.{'} \.{=} 0}%
 \@x{\@s{65.99} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{lab12} ]}%
\@x{\@s{65.99} \.{\land} {\UNCHANGED} {\langle} x ,\, b ,\, j {\rangle}}%
\@pvspace{8.0pt}%
\@x{ lab12 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{lab12}}%
 \@x{\@s{65.99} \.{\land} b \.{'} \.{=} [ b {\EXCEPT} {\bang} [ self ] \.{=}
 false ]}%
 \@x{\@s{65.99} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{ncs} ]}%
\@x{\@s{65.99} \.{\land} {\UNCHANGED} {\langle} x ,\, y ,\, j {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Proc ( self ) \.{\defeq} ncs ( self ) \.{\lor} start ( self ) \.{\lor}
 lab1 ( self ) \.{\lor} lab2 ( self )}%
 \@x{\@s{78.48} \.{\lor} lab3 ( self ) \.{\lor} lab4 ( self ) \.{\lor} lab5 (
 self ) \.{\lor} lab6 ( self )}%
 \@x{\@s{78.48} \.{\lor} lab7 ( self ) \.{\lor} lab8 ( self ) \.{\lor} lab9 (
 self ) \.{\lor} lab10 ( self )}%
 \@x{\@s{78.48} \.{\lor} cs ( self ) \.{\lor} lab11 ( self ) \.{\lor} lab12 (
 self )}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} ( \E\, self \.{\in} 1 \.{\dotdot} N \.{:} Proc ( self )
 )}%
\@x{\@s{47.82} \.{\lor}}%
\@y{\@s{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Mar} 29 13:58:04 \ensuremath{EDT} 2018 by \ensuremath{SabraouM
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Mar} 26
 15:54:05 \ensuremath{EDT} 2018 by \ensuremath{SabraouM
}%
\end{cpar}%
\end{lcom}%
\end{document}
