...
\@x{}\moduleLeftDash\@xx{ {\MODULE} CommCell}\moduleRightDash\@xx{}%
\@x{}%
\@y{%
 https:\ensuremath{\.{\slsl}elixir.bootlin.com}/linux/\ensuremath{v4}.2/source/drivers/tty/serial/\ensuremath{serial\_core.c
}}%
\@xx{}%
\@x{}%
\@y{%
 http:\ensuremath{\.{\slsl}www.modbus.org}/docs/\ensuremath{Modbus\_over\_serial\_line\_V1.pdf
}}%
\@xx{}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmalgorithm} RxTx}%
\@x{ {\p@lbrace}}%
\@x{\@s{16.4}}%
\@y{%
 \ensuremath{tx} is there is something to send, \ensuremath{rx} is there is
 something to receive
}%
\@xx{}%
\@x{\@s{12.29} {\p@variables}}%
\@x{\@s{32.8} isIdle \.{=} {\TRUE} ,\,}%
\@x{\@s{32.8} startMsg \.{=}\@w{:} ,\,}%
\@x{\@s{32.8} end1 \.{=}\@w{CR} ,\,}%
\@x{\@s{32.8} end2 \.{=}\@w{LF} ,\,}%
\@x{\@s{32.8} tx\@s{0.89} \.{=} {\FALSE} ,\,}%
\@y{%
 set by application if the buffer contains a message to send
}%
\@xx{}%
\@x{\@s{32.8} rx \.{=} {\FALSE} ,\,}%
\@y{\@s{0}%
 set by code below when we\mbox{'}ve received a full, valid frame ready to be
 processed
}%
\@xx{}%
\@x{\@s{32.8} txReg\@s{0.89} \.{\in} 0 \.{\dotdot} 255 ,\,}%
\@x{\@s{32.8} rxReg \.{\in} 0 \.{\dotdot} 255 ,\,}%
\@x{\@s{32.8} rxBuffCount \.{=} 0 {\p@semicolon}}%
\@x{\@s{32.8} txBuffCount\@s{0.89} \.{=} 0 ,\,}%
\@x{\@s{32.8} isValidCRC \.{=} {\TRUE} {\p@semicolon}}%
\@x{\@s{32.8} isValidModbus \.{=} {\TRUE} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 Station is idle
...
\@x{\@s{16.4}}%
\@y{\@s{0}%
 can \ensuremath{rx} or \ensuremath{tx
}}%
\@xx{}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 \ensuremath{tx} \cdash{33}
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{\@s{16.4} {\p@process} {\p@lparen} Serial \.{=}\@w{Serial} {\p@rparen}}%
\@x{\@s{16.4} {\p@lbrace}}%
 \@x{\@s{32.8} idle\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen} {\TRUE}
 {\p@rparen}}%
\@x{\@s{32.8} {\p@lbrace}}%
\@x{\@s{49.19} isIdle \.{:=} {\TRUE} {\p@semicolon}}%
\@x{\@s{49.19}}%
\@y{%
...
\@x{\@s{49.19}}%
\@y{%
 and if the buffer contains a valid \ensuremath{Modbus} frame
 (\ensuremath{TODO})
}%
\@xx{}%
 \@x{\@s{49.19} switchToTx\@s{.5}\textrm{:}\@s{3} {\p@if} {\p@lparen} tx \.{=}
 {\TRUE} \.{\,\&\&\,} txBuffCount \.{\,\backslash\,} \.{=} 0 \.{\,\&\&\,}
 isValidModbus {\p@rparen}}%
\@x{\@s{49.19} {\p@lbrace}}%
\@x{\@s{65.6}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{65.6} emission\_start\@s{.5}\textrm{:}\@s{3} isIdle\@s{4.1} \.{:=}
 {\FALSE} {\p@semicolon}}%
\@x{\@s{135.97} txReg\@s{4.32} \.{:=} startMsg {\p@semicolon}}%
\@x{\@s{65.6}}%
\@y{\@s{0}%
 while there is stuff to send, keep sending it byte by byte
}%
\@xx{}%
 \@x{\@s{65.6} emission\@s{.5}\textrm{:}\@s{3}\@s{8.2} {\p@while} {\p@lparen}
 l1 \.{:} txBuffCount \.{\,\backslash\,} \.{=} 0 {\p@rparen}}%
\@x{\@s{118.66} {\p@lbrace}}%
\@x{\@s{135.06} l2\@s{.5}\textrm{:}\@s{3} txReg \.{:=} txBuff {\p@semicolon}}%
\@x{\@s{149.93} txBuffCount \.{:=} txBuffCount \.{-} 1 {\p@semicolon}}%
\@x{\@s{118.66} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{65.6}}%
\@y{\@s{0}%
 when the register is empty send the \ensuremath{CR}/\ensuremath{LF} and go
 back to idle
}%
\@xx{}%
 \@x{\@s{65.6} emission\_end\@s{.5}\textrm{:}\@s{3} txReg \.{:=} end1
 {\p@semicolon}}%
 \@x{\@s{65.6} backToIdle\@s{.5}\textrm{:}\@s{3} txReg \.{:=} end2
 {\p@semicolon}}%
\@x{\@s{127.36} tx \.{:=} {\FALSE}\@s{2.43} {\p@semicolon}}%
\@x{\@s{127.36} {\p@goto} idle {\p@semicolon}}%
\@x{\@s{49.19} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{49.19}}%
\@y{\@s{0}%
 if we are receiving something (there is a \ensuremath{\@w{:}} in the
 \ensuremath{rx} register)
}%
\@xx{}%
 \@x{\@s{49.19} switchToRx\@s{.5}\textrm{:}\@s{3} {\p@if} {\p@lparen} rxReg
 \.{=} startMsg {\p@rparen}}%
\@x{\@s{49.19} {\p@lbrace}}%
\@x{\@s{65.6}}%
\@y{%
...
\@xx{}%
 \@x{\@s{65.6} reception\@s{.5}\textrm{:}\@s{3}\@s{8.05} isIdle \.{:=}
 {\FALSE} {\p@semicolon}}%
\@x{\@s{123.51} rxBuffCount \.{:=} 0 {\p@semicolon}}%
\@x{\@s{123.51}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{123.51} r1\@s{.5}\textrm{:}\@s{3} {\p@if} {\p@lparen} rxReg \.{=}
 startMsg {\p@rparen} {\p@lbrace} {\p@goto} reception {\p@rbrace}
 {\p@semicolon}}%
\@y{%
 can receive \ensuremath{\@w{:}} multiple times
}%
\@xx{}%
\@x{\@s{123.51}}%
\@y{%
...
\@xx{}%
 \@x{\@s{123.51} r2\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen} rxReg
 \.{\,\backslash\,} \.{=}\@w{CR} {\p@rparen}}%
\@x{\@s{140.08} {\p@lbrace}}%
 \@x{\@s{156.48} {\p@if} {\p@lparen} rxReg \.{=} startMsg {\p@rparen}
 {\p@lbrace} {\p@goto} reception {\p@semicolon} {\p@rbrace} {\p@semicolon}}%
 \@x{\@s{156.48} r3\@s{.5}\textrm{:}\@s{3}\@s{6.37} rxBuffCount \.{:=}
 rxBuffCount \.{+} 1 {\p@semicolon}}%
\@x{\@s{179.43} rxBuff [ rxBuffCount ] \.{:=} rxReg {\p@semicolon}}%
\@x{\@s{140.08} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{123.51}}%
\@y{%
 handle end of frame, check if valid modbus (\ensuremath{TODO})
}%
\@xx{}%
\@x{\@s{123.51}}%
\@y{%
 handle \ensuremath{CRC} (\ensuremath{TODO})
}%
\@xx{}%
 \@x{\@s{65.6} endFrame\@s{.5}\textrm{:}\@s{3}\@s{8.19} {\p@if} {\p@lparen}
 rxReg \.{=} startMsg {\p@rparen} {\p@lbrace} {\p@goto} reception
 {\p@semicolon} {\p@rbrace} {\p@semicolon}}%
 \@x{\@s{123.51} r4\@s{.5}\textrm{:}\@s{3}\@s{6.37} {\p@if} {\p@lparen} rxReg
 \.{=} end2 \.{\,\&\&\,} isValidModbus \.{\,\&\&\,} isValidCRC {\p@rparen}}%
\@x{\@s{146.46} {\p@lbrace}}%
\@x{\@s{146.46}}%
\@y{%
 if we get \ensuremath{LF}\ensuremath{\backslash}CR and the \ensuremath{CRC}
 is good and the frame is valid modbus
}%
\@xx{}%
\@x{\@s{146.46}}%
\@y{%
 then signal to the application that the \ensuremath{rx} buffer is ready to
 process
}%
\@xx{}%
\@x{\@s{162.86} rx \.{:=} {\TRUE} {\p@semicolon}}%
\@x{\@s{146.46} {\p@rbrace} {\p@semicolon}}%
\@pvspace{16.0pt}%
\@x{\@s{49.19} {\p@rbrace} {\p@semicolon}}%
...
\@xx{}%
 \@x{ {\VARIABLES} isIdle ,\, startMsg ,\, end1 ,\, end2 ,\, tx ,\, rx ,\,
 txReg ,\, rxReg ,\, rxBuffCount ,\,}%
\@x{\@s{51.42} txBuffCount ,\, isValidCRC ,\, isValidModbus ,\, pc}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} isIdle ,\, startMsg ,\, end1 ,\, end2 ,\, tx
 ,\, rx ,\, txReg ,\, rxReg ,\, rxBuffCount ,\,}%
\@x{\@s{41.61} txBuffCount ,\, isValidCRC ,\, isValidModbus ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ProcSet \.{\defeq} \{\@w{Serial} \}}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{35.70} \.{\land} isIdle \.{=} {\TRUE}}%
\@x{\@s{35.70} \.{\land} startMsg \.{=}\@w{:}}%
\@x{\@s{35.70} \.{\land} end1 \.{=}\@w{CR}}%
\@x{\@s{35.70} \.{\land} end2 \.{=}\@w{LF}}%
\@x{\@s{35.70} \.{\land} tx\@s{0.89} \.{=} {\FALSE}}%
\@x{\@s{35.70} \.{\land} rx \.{=} {\FALSE}}%
\@x{\@s{35.70} \.{\land} txReg\@s{0.89} \.{\in} 0 \.{\dotdot} 255}%
\@x{\@s{35.70} \.{\land} rxReg \.{\in} 0 \.{\dotdot} 255}%
\@x{\@s{35.70} \.{\land} rxBuffCount \.{=} 0}%
\@x{\@s{35.70} \.{\land} txBuffCount\@s{0.89} \.{=} 0}%
\@x{\@s{35.70} \.{\land} isValidCRC \.{=} {\TRUE}}%
\@x{\@s{35.70} \.{\land} isValidModbus \.{=} {\TRUE}}%
 \@x{\@s{35.70} \.{\land} pc \.{=} [ self \.{\in} ProcSet \.{\mapsto}\@w{idle}
 ]}%
\@pvspace{8.0pt}%
\@x{ idle\@s{0.21} \.{\defeq} \.{\land} pc [\@w{Serial} ] \.{=}\@w{idle}}%
\@x{\@s{35.70} \.{\land} isIdle \.{'} \.{=} {\TRUE}}%
 \@x{\@s{35.70} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [\@w{Serial} ]
 \.{=}\@w{switchToTx} ]}%
 \@x{\@s{35.70} \.{\land} {\UNCHANGED} {\langle} startMsg ,\, end1 ,\, end2
 ,\, tx ,\, rx ,\, txReg ,\, rxReg ,\,}%
 \@x{\@s{109.29} rxBuffCount ,\, txBuffCount ,\, isValidCRC ,\, isValidModbus
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ switchToTx \.{\defeq} \.{\land} pc [\@w{Serial} ] \.{=}\@w{switchToTx}}%
 \@x{\@s{70.22} \.{\land} {\IF} tx \.{=} {\TRUE} \.{\,\&\&\,} txBuffCount
 \.{\,\backslash\,} \.{=} 0 \.{\,\&\&\,} isValidModbus}%
 \@x{\@s{93.48} \.{\THEN} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang}
 [\@w{Serial} ] \.{=}\@w{emission\_start} ]}%
 \@x{\@s{93.48} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang}
 [\@w{Serial} ] \.{=}\@w{switchToRx} ]}%
 \@x{\@s{70.22} \.{\land} {\UNCHANGED} {\langle} isIdle ,\, startMsg ,\, end1
 ,\, end2 ,\, tx ,\, rx ,\, txReg ,\,}%
\@x{\@s{143.80} rxReg ,\, rxBuffCount ,\, txBuffCount ,\, isValidCRC ,\,}%
\@x{\@s{143.80} isValidModbus {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ emission\_start \.{\defeq} \.{\land} pc [\@w{Serial} ]
 \.{=}\@w{emission\_start}}%
\@x{\@s{82.98} \.{\land} isIdle \.{'} \.{=} {\FALSE}}%
\@x{\@s{82.98} \.{\land} txReg \.{'} \.{=} startMsg}%
 \@x{\@s{82.98} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [\@w{Serial} ]
 \.{=}\@w{emission} ]}%
 \@x{\@s{82.98} \.{\land} {\UNCHANGED} {\langle} startMsg ,\, end1 ,\, end2
 ,\, tx ,\, rx ,\, rxReg ,\,}%
\@x{\@s{156.57} rxBuffCount ,\, txBuffCount ,\, isValidCRC ,\,}%
\@x{\@s{156.57} isValidModbus {\rangle}}%
\@pvspace{8.0pt}%
\@x{ emission \.{\defeq} \.{\land} pc [\@w{Serial} ] \.{=}\@w{emission}}%
 \@x{\@s{57.47} \.{\land} {\IF} l1 \.{:} txBuffCount \.{\,\backslash\,} \.{=}
 0}%
 \@x{\@s{80.74} \.{\THEN} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang}
 [\@w{Serial} ] \.{=}\@w{l2} ]}%
 \@x{\@s{80.74} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang}
 [\@w{Serial} ] \.{=}\@w{emission\_end} ]}%
 \@x{\@s{57.47} \.{\land} {\UNCHANGED} {\langle} isIdle ,\, startMsg ,\, end1
 ,\, end2 ,\, tx ,\, rx ,\, txReg ,\, rxReg ,\,}%
\@x{\@s{131.06} rxBuffCount ,\, txBuffCount ,\, isValidCRC ,\,}%
\@x{\@s{131.06} isValidModbus {\rangle}}%
\@pvspace{8.0pt}%
\@x{ l2 \.{\defeq} \.{\land} pc [\@w{Serial} ] \.{=}\@w{l2}}%
\@x{\@s{27.47} \.{\land} txReg \.{'} \.{=} txBuff}%
\@x{\@s{27.47} \.{\land} txBuffCount \.{'} \.{=} txBuffCount \.{-} 1}%
 \@x{\@s{27.47} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [\@w{Serial} ]
 \.{=}\@w{emission} ]}%
 \@x{\@s{27.47} \.{\land} {\UNCHANGED} {\langle} isIdle ,\, startMsg ,\, end1
 ,\, end2 ,\, tx ,\, rx ,\, rxReg ,\, rxBuffCount ,\,}%
\@x{\@s{101.06} isValidCRC ,\, isValidModbus {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ emission\_end \.{\defeq} \.{\land} pc [\@w{Serial} ]
 \.{=}\@w{emission\_end}}%
\@x{\@s{78.34} \.{\land} txReg \.{'} \.{=} end1}%
 \@x{\@s{78.34} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [\@w{Serial} ]
 \.{=}\@w{backToIdle} ]}%
 \@x{\@s{78.34} \.{\land} {\UNCHANGED} {\langle} isIdle ,\, startMsg ,\, end1
 ,\, end2 ,\, tx ,\, rx ,\, rxReg ,\,}%
\@x{\@s{151.93} rxBuffCount ,\, txBuffCount ,\, isValidCRC ,\,}%
\@x{\@s{151.93} isValidModbus {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ backToIdle\@s{4.18} \.{\defeq} \.{\land} pc [\@w{Serial} ]
 \.{=}\@w{backToIdle}}%
\@x{\@s{70.35} \.{\land} txReg \.{'} \.{=} end2}%
\@x{\@s{70.35} \.{\land} tx \.{'}\@s{0.59} \.{=} {\FALSE}}%
 \@x{\@s{70.35} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [\@w{Serial} ]
 \.{=}\@w{idle} ]}%
 \@x{\@s{70.35} \.{\land} {\UNCHANGED} {\langle} isIdle ,\, startMsg ,\, end1
 ,\, end2 ,\, rx ,\, rxReg ,\,}%
\@x{\@s{143.94} rxBuffCount ,\, txBuffCount ,\, isValidCRC ,\,}%
\@x{\@s{143.94} isValidModbus {\rangle}}%
\@pvspace{8.0pt}%
\@x{ switchToRx \.{\defeq} \.{\land} pc [\@w{Serial} ] \.{=}\@w{switchToRx}}%
\@x{\@s{70.35} \.{\land} {\IF} rxReg \.{=} startMsg}%
 \@x{\@s{93.62} \.{\THEN} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang}
 [\@w{Serial} ] \.{=}\@w{reception} ]}%
 \@x{\@s{93.62} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang}
 [\@w{Serial} ] \.{=}\@w{idle} ]}%
 \@x{\@s{70.35} \.{\land} {\UNCHANGED} {\langle} isIdle ,\, startMsg ,\, end1
 ,\, end2 ,\, tx ,\, rx ,\, txReg ,\,}%
\@x{\@s{143.94} rxReg ,\, rxBuffCount ,\, txBuffCount ,\, isValidCRC ,\,}%
\@x{\@s{143.94} isValidModbus {\rangle}}%
\@pvspace{8.0pt}%
\@x{ reception \.{\defeq} \.{\land} pc [\@w{Serial} ] \.{=}\@w{reception}}%
\@x{\@s{58.37} \.{\land} isIdle \.{'} \.{=} {\FALSE}}%
\@x{\@s{58.37} \.{\land} rxBuffCount \.{'} \.{=} 0}%
 \@x{\@s{58.37} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [\@w{Serial} ]
 \.{=}\@w{r1} ]}%
 \@x{\@s{58.37} \.{\land} {\UNCHANGED} {\langle} startMsg ,\, end1 ,\, end2
 ,\, tx ,\, rx ,\, txReg ,\, rxReg ,\,}%
\@x{\@s{131.96} txBuffCount ,\, isValidCRC ,\, isValidModbus {\rangle}}%
\@pvspace{8.0pt}%
\@x{ r1 \.{\defeq} \.{\land} pc [\@w{Serial} ] \.{=}\@w{r1}}%
\@x{\@s{29.18} \.{\land} {\IF} rxReg \.{=} startMsg}%
 \@x{\@s{52.44} \.{\THEN} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang}
 [\@w{Serial} ] \.{=}\@w{reception} ]}%
 \@x{\@s{52.44} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang}
 [\@w{Serial} ] \.{=}\@w{r2} ]}%
 \@x{\@s{29.18} \.{\land} {\UNCHANGED} {\langle} isIdle ,\, startMsg ,\, end1
 ,\, end2 ,\, tx ,\, rx ,\, txReg ,\, rxReg ,\,}%
 \@x{\@s{102.77} rxBuffCount ,\, txBuffCount ,\, isValidCRC ,\, isValidModbus
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ r2 \.{\defeq} \.{\land} pc [\@w{Serial} ] \.{=}\@w{r2}}%
\@x{\@s{29.18} \.{\land} {\IF} rxReg \.{\,\backslash\,} \.{=}\@w{CR}}%
\@x{\@s{52.44} \.{\THEN} \.{\land} {\IF} rxReg \.{=} startMsg}%
 \@x{\@s{107.02} \.{\THEN} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang}
 [\@w{Serial} ] \.{=}\@w{reception} ]}%
 \@x{\@s{107.02} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang}
 [\@w{Serial} ] \.{=}\@w{r3} ]}%
 \@x{\@s{52.44} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang}
 [\@w{Serial} ] \.{=}\@w{endFrame} ]}%
 \@x{\@s{29.18} \.{\land} {\UNCHANGED} {\langle} isIdle ,\, startMsg ,\, end1
 ...
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ r3 \.{\defeq} \.{\land} pc [\@w{Serial} ]\@s{9.40} \.{=}\@w{r3}}%
\@x{\@s{29.18} \.{\land} rxBuffCount \.{'} \.{=} rxBuffCount \.{+} 1}%
 \@x{\@s{29.18} \.{\land} rxBuff \.{'} \.{=} [ rxBuff {\EXCEPT} {\bang} [
 rxBuffCount \.{'} ] \.{=} rxReg ]}%
 \@x{\@s{29.18} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [\@w{Serial} ]
 \.{=}\@w{r2} ]}%
 \@x{\@s{29.18} \.{\land} {\UNCHANGED} {\langle} isIdle ,\, startMsg ,\, end1
 ,\, end2 ,\, tx ,\, rx ,\, txReg ,\, rxReg ,\,}%
\@x{\@s{102.77} txBuffCount ,\, isValidCRC ,\, isValidModbus {\rangle}}%
\@pvspace{8.0pt}%
\@x{ endFrame \.{\defeq} \.{\land} pc [\@w{Serial} ] \.{=}\@w{endFrame}}%
\@x{\@s{62.32} \.{\land} {\IF} rxReg \.{=} startMsg}%
 \@x{\@s{85.59} \.{\THEN} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang}
 [\@w{Serial} ] \.{=}\@w{reception} ]}%
 \@x{\@s{85.59} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang}
 [\@w{Serial} ] \.{=}\@w{r4} ]}%
 \@x{\@s{62.32} \.{\land} {\UNCHANGED} {\langle} isIdle ,\, startMsg ,\, end1
 ,\, end2 ,\, tx ,\, rx ,\, txReg ,\, rxReg ,\,}%
\@x{\@s{135.91} rxBuffCount ,\, txBuffCount ,\, isValidCRC ,\,}%
\@x{\@s{135.91} isValidModbus {\rangle}}%
\@pvspace{8.0pt}%
\@x{ r4 \.{\defeq} \.{\land} pc [\@w{Serial} ] \.{=}\@w{r4}}%
 \@x{\@s{29.18} \.{\land} {\IF} rxReg \.{=} end2 \.{\,\&\&\,} isValidModbus
 \.{\,\&\&\,} isValidCRC}%
\@x{\@s{52.44} \.{\THEN} \.{\land} rx \.{'} \.{=} {\TRUE}}%
\@x{\@s{52.44} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{83.75} \.{\land} rx \.{'} \.{=} rx}%
 \@x{\@s{29.18} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [\@w{Serial} ]
 \.{=}\@w{idle} ]}%
 \@x{\@s{29.18} \.{\land} {\UNCHANGED} {\langle} isIdle ,\, startMsg ,\, end1
 ,\, end2 ,\, tx ,\, txReg ,\, rxReg ,\,}%
 ...
 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Serial \.{\defeq} idle \.{\lor} switchToTx\@s{3.82} \.{\lor}
 emission\_start \.{\lor} emission \.{\lor} l2}%
 \@x{\@s{57.39} \.{\lor} emission\_end \.{\lor} backToIdle \.{\lor} switchToRx
 \.{\lor} reception \.{\lor} r1}%
\@x{\@s{57.39} \.{\lor} r2 \.{\lor} r3 \.{\lor} endFrame \.{\lor} r4}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} Serial}%
\@pvspace{8.0pt}%
