...
\@x{ {\EXTENDS} Integers}%
\@pvspace{8.0pt}%
 \@x{ p \.{\,|\,} q \.{\defeq} \E\, d \.{\in} 1 \.{\dotdot} q \.{:} q \.{=} p
 \.{*} d}%
\@pvspace{8.0pt}%
 \@x{ Divisors ( q ) \.{\defeq} \{ d \.{\in} 1 \.{\dotdot} q \.{:} d \.{\,|\,}
 q \}}%
\@pvspace{8.0pt}%
 \@x{ Maximum ( S ) \.{\defeq} {\CHOOSE} x \.{\in} S \.{:} \forall\, y \.{\in}
 S \.{:} x \.{\geq} y}%
\@pvspace{8.0pt}%
 \@x{ GCD ( p ,\, q ) \.{\defeq} Maximum ( Divisors ( p ) \.{\cap} Divisors (
 q ) )}%
\@pvspace{8.0pt}%
\@x{ Number \.{\defeq} Nat \.{\,\backslash\,} \{ 0 \}}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Mar} 12 18:57:36 \ensuremath{EDT} 2018 by \ensuremath{SabraouM
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Mon}
 \ensuremath{Mar} 12 18:44:22 \ensuremath{EDT} 2018 by \ensuremath{SabraouM
}%
\end{cpar}%
\end{lcom}%
\end{document}
