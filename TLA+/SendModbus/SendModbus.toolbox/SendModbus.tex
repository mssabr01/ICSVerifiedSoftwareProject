...
\@x{}\moduleLeftDash\@xx{ {\MODULE} SendModbus}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} Sequences ,\,}%
\@x{\@s{43.93} Naturals ,\,}%
\@x{\@s{43.93} Modbus ,\,}%
...
\@x{ {\LOCAL} {\INSTANCE} Hex}%
 ...
 {\langle} 0 {\rangle}}%
\@x{ MessagesFromCryptoCell \.{\defeq}}%
 ...
 {\rangle} ,\,}%
 \@x{\@s{21.40} {\langle}\@w{:} ,\,\@w{J} ,\,\@w{G} ,\,\@w{P} ,\,\@w{9}
 ,\,\@w{4} ,\,\@w{3} ,\,\@w{2} ,\,\@w{J} ,\,\@w{3} ,\,\@w{9} ,\,\@w{J}
 ,\,\@w{G} ,\,\@w{W} ,\,\@w{:} ,\,\@w{1} ,\,\@w{1} ,\,\@w{0} ,\,\@w{3}
 ,\,\@w{0} ,\,\@w{0} ,\,\@w{6} ,\,\@w{B} ,\,\@w{0} ,\,\@w{0} ,\,\@w{0}
 ,\,\@w{3} ,\,\@w{7} ,\,\@w{E} ,\,\@w{C} ,\,\@w{R} ,\,\@w{L} ,\,\@w{F}
 {\rangle} ,\,}%
...
\@x{}%
\@y{%
 This algorithm didn\mbox{'}t translate correctly. If \ensuremath{I} have
 time \ensuremath{I}\mbox{'}ll break it down and post a bug report
}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ {\VARIABLES} tx ,\, txBuf ,\, txBufIndex ,\, pc ,\, txReg ,\, message}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} tx ,\, txBuf ,\, txBufIndex ,\, pc ,\, txReg
 ,\, message {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{2.02} \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{37.72} \.{\land} tx \.{\in} {\BOOLEAN}}%
\@x{\@s{37.72} \.{\land} message \.{\in} MessagesFromCryptoCell}%
\@x{\@s{37.72} \.{\land} txBuf \.{=} {\langle} {\rangle}}%
\@x{\@s{37.72} \.{\land} txReg\@s{1.23} \.{=}\@w{}}%
\@x{\@s{37.72} \.{\land} txBufIndex \.{=} 1}%
\@x{\@s{37.72} \.{\land} pc \.{=}\@w{idle}}%
\@pvspace{8.0pt}%
\@x{ idle\@s{2.24} \.{\defeq} \.{\land} pc \.{=}\@w{idle}}%
\@x{\@s{37.72} \.{\land} txBuf \.{'} \.{=} message}%
\@x{\@s{37.72} \.{\land} {\IF} tx \.{=} {\TRUE}}%
\@x{\@s{60.99} \.{\THEN} \.{\land} pc \.{'} \.{=}\@w{transmit}}%
\@x{\@s{60.99} \.{\ELSE} \.{\land} pc \.{'} \.{=}\@w{Done}}%
 \@x{\@s{37.72} \.{\land} {\UNCHANGED} {\langle} tx ,\, txBufIndex ,\, txReg
 ,\, message {\rangle}}%
\@pvspace{8.0pt}%
\@x{ transmit \.{\defeq} \.{\land} pc \.{=}\@w{transmit}}%
\@x{\@s{56.25} \.{\land} {\IF} IsModbus ( txBuf )}%
\@x{\@s{79.52} \.{\THEN} \.{\land} pc \.{'} \.{=}\@w{send}}%
\@x{\@s{79.52} \.{\ELSE} \.{\land} pc \.{'} \.{=}\@w{t1}}%
 \@x{\@s{56.25} \.{\land} {\UNCHANGED} {\langle} tx ,\, txBuf ,\, txReg ,\,
 txBufIndex ,\, message {\rangle}}%
\@pvspace{8.0pt}%
\@x{ send \.{\defeq} \.{\land} pc \.{=}\@w{send}}%
\@x{\@s{39.34} \.{\land} {\IF} Len ( txBuf ) \.{>} 1}%
\@x{\@s{62.61} \.{\THEN} \.{\land} pc \.{'} \.{=}\@w{a}}%
\@x{\@s{93.92} \.{\land} txReg \.{'} \.{=} txReg}%
\@x{\@s{62.61} \.{\ELSE} \.{\land} pc \.{'} \.{=}\@w{t1}}%
\@x{\@s{93.92} \.{\land} txReg \.{'} \.{=} Head ( txBuf )}%
 \@x{\@s{39.34} \.{\land} {\UNCHANGED} {\langle} tx ,\, txBuf ,\, txBufIndex
 ,\, message {\rangle}}%
\@pvspace{8.0pt}%
\@x{ a \.{\defeq} \.{\land} pc \.{=}\@w{a}}%
\@x{\@s{24.76} \.{\land} txReg \.{'}\@s{1.23} \.{=} Head ( txBuf )}%
\@x{\@s{24.76} \.{\land} txBuf \.{'} \.{=} Tail ( txBuf )}%
\@x{\@s{24.76} \.{\land} pc \.{'} \.{=}\@w{b}}%
 \@x{\@s{24.76} \.{\land} {\UNCHANGED} {\langle} tx ,\, txBufIndex ,\, message
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ b\@s{0.64} \.{\defeq} \.{\land} pc \.{=}\@w{b}}%
\@x{\@s{24.76} \.{\land} txBufIndex \.{'} \.{=} txBufIndex \.{+} 1}%
\@x{\@s{24.76} \.{\land} pc \.{'} \.{=}\@w{send}}%
 \@x{\@s{24.76} \.{\land} {\UNCHANGED} {\langle} tx ,\, txBuf ,\, txReg ,\,
 message {\rangle}}%
\@pvspace{8.0pt}%
\@x{ t1 \.{\defeq} \.{\land} pc \.{=}\@w{t1}}%
\@x{\@s{28.15} \.{\land} txReg \.{'} \.{=}\@w{}}%
\@x{\@s{28.15} \.{\land} tx \.{'}\@s{0.59} \.{=} {\FALSE}}%
\@x{\@s{28.15} \.{\land} pc \.{'} \.{=}\@w{Done}}%
 \@x{\@s{28.15} \.{\land} {\UNCHANGED} {\langle} txBuf ,\, txBufIndex ,\,
 message {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} idle \.{\lor} transmit \.{\lor} send \.{\lor} a \.{\lor}
 b \.{\lor} t1}%
\@x{\@s{52.13} \.{\lor}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{16.4} \.{\land} ( tx \.{=} {\TRUE} \.{\land} IsModbus ( txBuf ) )
 \.{\leadsto} Len ( txBuf ) \.{=} 1}%
\@x{}%
\@y{%
...
\@xx{}%
 \@x{\@s{16.4} \.{\land} ( tx \.{=} {\TRUE} ) \.{\leadsto} ( tx \.{=} {\FALSE}
 )}%
\@pvspace{8.0pt}%
\@x{ SAFETYCHECK \.{\defeq}}%
\@x{}%
...
\@xx{}%
\@x{\@s{16.4} \.{\land} ( txReg \.{\in} ModbusChar )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 END TRANSLATION
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun May 06 22:05:46
 \ensuremath{EDT} 2018 by \ensuremath{SabraouM
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} May 04 22:08:30
 \ensuremath{EDT} 2018 by \ensuremath{SabraouM
}%
\end{cpar}%
\end{lcom}%
