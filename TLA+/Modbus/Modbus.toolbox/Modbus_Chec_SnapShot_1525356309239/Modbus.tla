...
IsData(str) == 
    \*/\ Len(str) \in 0..504
    /\ str = [x \in Range(str) |-> x \in HexChar]
...
ASSUME
  \*
  /\ Print(IsModbus(<<":","J","G","P","9","4","3","2","J","3","9","J","G","W","I","R","W">>), TRUE)
  \*/\ Print(IsModbus(<<":","1","1","0","3","0","0","6","B","0","0","0","3","7","E","C","R","L","F">>), TRUE)
  \*/\ Print(IsModbus(<<"e","j","g","p","9","4","3","2","j","3","9","j","g","w","i","r","w">>), TRUE)
=============================================================================
\* Modification History
\* Last modified Thu May 03 10:05:03 EDT 2018 by SabraouM
