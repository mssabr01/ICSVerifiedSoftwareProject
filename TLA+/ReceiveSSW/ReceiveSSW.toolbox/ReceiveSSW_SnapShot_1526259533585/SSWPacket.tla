...
\*Start ==================================================================
LOCAL IsStart(str) == str = "f" \*start with something that isn't hex so we can tell a new message from an HMAC
ASSUME PrintVal("Is this a start?", IsStart("f"))
...
\* Last modified Sun May 13 20:58:41 EDT 2018 by SabraouM
