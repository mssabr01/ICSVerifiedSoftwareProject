...
CharToNum(char) == IF TRUE \*char \in usableASCII 
                   THEN 31 + CHOOSE i \in 1 .. 96 : usableASCII[i] = char
...
RECURSIVE StrArrayToNumArray(_)
StrArrayToNumArray(array) ==
    IF array = <<>>
    THEN <<>>
    ELSE <<CharToNum(Head(array))>> \o StrArrayToNumArray(Tail(array))
...
ASSUME PrintVal("StrArrayToNumArray", StrArrayToNumArray(ismod))
                                   \*= <<58, 49, 49, 48, 51, 48, 48, 54, 66, 48, 48, 48, 51, 55, 69, 13, 10>>)
                                    


=============================================================================
\* Modification History
\* Last modified Fri May 11 23:48:17 EDT 2018 by SabraouM
